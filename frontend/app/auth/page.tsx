      ...
      >
        <div className="volumetric-glass-card p-8 md:p-10 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            >
              <div className="relative px-6 py-3 bg-[rgba(10,10,15,0.8)] backdrop-blur-xl rounded-[100px] flex items-center justify-center gap-3 w-full h-full transition-all duration-300 group-hover:bg-[rgba(20,20,30,0.8)]">
                ...
                <span className="font-semibold text-[14px] tracking-wide text-white/90">Continue with Google</span>
              </div>
            </button>
